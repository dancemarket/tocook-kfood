...
export const metadata = {
  title: {
    default: 'toCook kFood | 한국 제철 식재료 레시피 블로그',
    template: '%s | toCook kFood',
  },
  ...
  authors: [{ name: 'toCook kFood' }],
  creator: 'toCook kFood',
  openGraph: {
    title: 'toCook kFood | Korean Seasonal Recipe Blog',
